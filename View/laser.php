                ...
                <div class="col-12 ">
                    ...
                    <div class="row  mt-5 p-2">
                        <!-- <div class="col-12 ">
                            ...
                            <select class=" form-control form-control-sm custom-select mr-sm-2" id="almacen"
                                aria-describedby="helpId2" onchange="ponleFocus()">
                        ...
                        <div class="col-12 mt-3">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <input type="text" class="form-control" id="codigo" aria-describedby="helpId"
                                    placeholder="">
